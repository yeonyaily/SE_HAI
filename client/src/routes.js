...
const routes = [
  ...
  { path: '/institute/introduce/intromain/:inst_name', exact: true, name: 'Intromain', element: Intromain},
  { path: '/institute/introduce/write', exact: true, name: 'Introwrite', element: Introwrite},

  { path: '/institute/recruit/recruitmain/:inst_name', exact: true, name: 'Recruitmain', element: Recruitmain },
